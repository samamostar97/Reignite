    ...
    public class FaqConfiguration : BaseEntityConfiguration<Faq>
    {
        public override void Configure(EntityTypeBuilder<Faq> builder)
        {
            ...
            builder.HasData(
                ...
                new Faq { Id = 3, Question = "Mogu li vratiti proizvod?", Answer = "Da, imate pravo na povrat proizvoda u roku od 14 dana od prijema. Proizvod mora biti nekorišten i u originalnom pakovanju. Kontaktirajte našu podršku za pokretanje povrata.", CreatedAt = seedDate },
                new Faq { Id = 4, Question = "Koji su načini plaćanja?", Answer = "Prihvatamo plaćanje karticama (Visa, Mastercard), pouzeće i bankovni transfer. Sva online plaćanja su zaštićena SSL enkripcijom.", CreatedAt = seedDate },
                new Faq { Id = 5, Question = "Kako mogu koristiti kupon za popust?", Answer = "Unesite kod kupona u predviđeno polje prilikom završetka narudžbe. Popust će biti automatski primijenjen na vašu narudžbu ako su ispunjeni uslovi kupona.", CreatedAt = seedDate }
            );
        }
    }
}
