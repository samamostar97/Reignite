...
export type AccountTab = 'profile' | 'address' | 'orders' | 'hobbies' | 'projects' | 'password';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ProfileTabComponent, AddressTabComponent, OrdersTabComponent, HobbiesTabComponent, ProjectsTabComponent, PasswordTabComponent, EmberBackgroundComponent, HeaderComponent],
...
export class AccountComponent {
  ...
  protected readonly tabs: TabItem[] = [
    ...
    { id: 'projects', label: 'Projekti', icon: 'M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3 3h18a1.5 1.5 0 011.5 1.5v15a1.5 1.5 0 01-1.5 1.5H3a1.5 1.5 0 01-1.5-1.5v-15A1.5 1.5 0 013 3z' },
